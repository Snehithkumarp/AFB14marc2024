...
async def youtube_dl_call_back(client, query):
    ...
    try:
        ...
        xLAZY_BAAPUx_init = await query.edit_message_text(
                        text=f"ღ♡ ɪɴɪᴛɪᴀᴛɪɴɢ 𝙼𝚗𝚃 ᴄᴏɴꜱᴛʀᴜᴄᴛɪᴏɴ ♡♪ \n⬇️⏬ {namee}",
                    )
        await query.edit_message_text(f"**ღ♡ ʀᴜɴɴɪɴɢ 𝙼𝚗𝚃 ᴄᴏɴꜱᴛʀᴜᴄᴛɪᴏɴ ♡♪**\n**ᵉⁿʲᵒʸ ˢᵘᵖᵉʳᶠᵃˢᵗ ᵈᵒʷⁿˡᵒᵈ ᵇʸ [𝙼𝚗𝚃_Linkss](https://t.me/MnT_Linkss)◔_◔** \n\n**░░✩ 📂𝐎𝐑𝐆 𝐅𝐈𝐋𝐄𝐍𝐀𝐌𝐄 ✩ **\n<code>{namee}</code>\n\n**░░✩ 📝𝐍𝐄𝐖 𝐍𝐀𝐌𝐄 ✩ **\n<code>{template_name}</code>\n\n███████████████████████\n⚡️**ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ** | 🧬ѕιzє: {sizee}", disable_web_page_preview=True,)
